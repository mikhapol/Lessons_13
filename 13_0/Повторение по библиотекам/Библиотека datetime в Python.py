...
#  — представляет собой интервал времени, который можно добавлять или вычитать из объектов datetime.

# datetime.datetime.replace(year=None, month=None, day=None, hour=None, minute=None, second=None, microsecond=None,
# tzinfo=None, *fold=0)
#  — возвращает новый объект datetime с измененными атрибутами.
